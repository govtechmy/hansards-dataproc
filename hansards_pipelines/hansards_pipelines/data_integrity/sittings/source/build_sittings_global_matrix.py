...
def build_sittings_global_matrix(houses: List[str]) -> Dict:
    ...
    for house in houses:
        ...
        prefix = f"checks/sittings/integrity/{house}/"
        ...
        for term_prefix in response["CommonPrefixes"]:
            ...
            try:
                source_key = f"checks/sittings/source/{house}/{term}/latest.json"
                db_key = f"checks/sittings/db/{house}/{term}/latest.json"
...
def consolidate_all_latest_json_into_one(houses: List[str]) -> Dict:
    ...
    for house in houses:
        ...
        for term_prefix in response["CommonPrefixes"]:
            ...
            latest_key = f"checks/sittings/integrity/{house}/{term}/latest.json"
