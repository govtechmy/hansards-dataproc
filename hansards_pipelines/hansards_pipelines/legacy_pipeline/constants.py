NON_SPEAKER_VERBS = [
    ...
    "not only that", "and also", "Peringatan", "Taman", "colonial", "clear", "rata", "mengikut", "Pemandu", "Latehan", "warning", "ranchangan", "relative", "Jumlah", "further", "menurut","di-luluskan","academic", "merayu", "employed", "left", "pikul", "very", "sometimes", "units",
